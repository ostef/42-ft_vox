...
SRC_DIR=Source
SRC_FILES=main.cpp core.cpp math.cpp noise.cpp renderer.cpp
OPENGL_SRC_FILES=OpenGL/opengl.cpp OpenGL/render_pass.cpp OpenGL/pipeline_state.cpp OpenGL/shader.cpp OpenGL/texture.cpp OpenGL/buffer.cpp
